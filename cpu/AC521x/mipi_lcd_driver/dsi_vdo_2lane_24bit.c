...
const static u8 init_cmd_list[] = {
 ...
 _W, DELAY(0), PACKET_DCS, SIZE(6),0xFF,0x77,0x01,0x00,0x00,0x13,
    ...
    _W, DELAY(0), PACKET_DCS, SIZE(3),0xC0,0xE9,0x03,

    _W, DELAY(0), PACKET_DCS, SIZE(3),0xC1,0x0a,0x02,

    _W, DELAY(0), PACKET_DCS, SIZE(3),0xC2,0x10,0x06,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xC7,0x00,//04

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xCC,0x18,

    _W, DELAY(0), PACKET_DCS, SIZE(17),0xB0,0x40,0x0B,0x58,0x0C,0x11,0x06,0x0B,0x08,0x09,0x26,0x06,0x15,0x18,0x6A,0x6E,0x4F,

    _W, DELAY(0), PACKET_DCS, SIZE(17),0xB1,0x40,0x11,0x57,0x0D,0x11,0x07,0x0B,0x09,0x08,0x26,0x05,0xD3,0x0D,0x6B,0x6E,0x4F,

    _W, DELAY(0), PACKET_DCS, SIZE(6),0xFF,0x77,0x01,0x00,0x00,0x11,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB0,0x56,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB1,0x3A,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB2,0x87,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB3,0x80,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB5,0x4E,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB7,0x85,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB8,0x10,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xB9,0x10,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xBC,0x03,

    _W, DELAY(0), PACKET_DCS, SIZE(2),0xC0,0x89,
    ...
    _W, DELAY(0), PACKET_DCS, SIZE(17),0xE5,0x04,0x5C,0xA0,0xA0,0x06,0x5C,0xA0,0xA0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(5),0xE6,0x00,0x00,0x33,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(3),0xE7,0x22,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(17),0xE8,0x05,0x5C,0xA0,0xA0,0x07,0x5C,0xA0,0xA0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(8),0xEB,0x02,0x00,0x40,0x40,0x00,0x00,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(3),0xEC,0x00,0x00,

    _W, DELAY(0), PACKET_DCS, SIZE(17),0xED,0xAA,0x45,0x0B,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xB0,0x54,0xAA,

    _W, DELAY(0), PACKET_DCS, SIZE(7),0xEF,0x08,0x08,0x08,0x45,0x3F,0x54,

    _W, DELAY(0), PACKET_DCS, SIZE(6),0xFF,0x77,0x01,0x00,0x00,0x13,

    _W, DELAY(10), PACKET_DCS, SIZE(3),0xE8,0x00,0x0E,
    ...
    _W, DELAY(0), PACKET_DCS, SIZE(2),0x36,0x00,//10
