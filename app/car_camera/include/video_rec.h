...
#else
#define    DISP_MAIN_WIN     0 //大小窗
#define    DISP_FRONT_WIN    1 //只前窗
#define    DISP_BACK_WIN     2//只后窗
#define    DISP_PARK_WIN     3//parking win
#define    DISP_RESET_WIN    4
#define    DISP_FORBIDDEN    5 //forbidden
